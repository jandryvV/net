<template>
  <div
    class="min-h-screen bg-linear-to-br from-primary/10 via-base-200 to-secondary/10 flex items-center justify-center p-4"
  >
        ...
        <div class="hidden lg:block space-y-8 p-8">
          <div class="space-y-4">
            <div class="flex items-center gap-3 mb-8">
              <div class="bg-linear-to-br from-primary to-secondary p-3 rounded-2xl shadow-lg">
                <svg
          ...
          <div class="space-y-4">
            <div
              class="flex items-start gap-4 p-4 bg-base-100/50 rounded-xl border border-base-300/50 backdrop-blur-sm"
            >
              ...
              <div>
                <h3 class="font-semibold text-base-content">
                  {{ t('auth.register.welcome.benefit1Title') }}
                </h3>
                <p class="text-sm text-base-content/60">
                  {{ t('auth.register.welcome.benefit1Desc') }}
                </p>
              </div>
            </div>
            ...
            >
              ...
              <div>
                <h3 class="font-semibold text-base-content">
                  {{ t('auth.register.welcome.benefit2Title') }}
                </h3>
                <p class="text-sm text-base-content/60">
                  {{ t('auth.register.welcome.benefit2Desc') }}
                </p>
              </div>
            </div>
            ...
            >
              ...
              <div>
                <h3 class="font-semibold text-base-content">
                  {{ t('auth.register.welcome.benefit3Title') }}
                </h3>
                <p class="text-sm text-base-content/60">
                  {{ t('auth.register.welcome.benefit3Desc') }}
                </p>
              </div>
            </div>
          </div>
        ...
        <div class="card bg-base-100 shadow-2xl border border-base-300/50 backdrop-blur-sm">
          <div class="card-body p-8">
            ...
            <div class="lg:hidden flex items-center justify-center gap-3 mb-6">
              <div class="bg-linear-to-br from-primary to-secondary p-2 rounded-xl">
                <svg
            ...
            <form @submit.prevent="handleRegister" class="space-y-5">
              ...
              <div class="form-control">
                ...
                <label class="label">
                  <span class="label-text-alt text-base-content/60">{{
                    t('auth.register.welcome.minCharacters')
                  }}</span>
                </label>
              </div>
              ...
              <div class="form-control">
                <label
                  class="label cursor-pointer justify-start gap-3 p-4 bg-base-200/50 rounded-xl hover:bg-base-200 transition-colors"
                >
                  <input
                    v-model="acceptTerms"
                    type="checkbox"
                  ...
                  <span class="label-text text-sm flex flex-col">
                    ...
                    <a
                      ...
                      class="link link-primary font-semibold cursor-pointer"
                      >{{ t('auth.register.termsOfUse') }}</a
                    >
                    {{ t('auth.register.and') }}
                    <a
                      @click="showPrivacy = true"
                      class="link link-primary font-semibold cursor-pointer"
                      >{{ t('auth.register.privacyPolicy') }}</a
                    >
                  </span>
                </label>
              </div>
    ...
    <div v-if="showTerms" class="modal modal-open">
      <div class="modal-box max-w-2xl">
        ...
        <div class="space-y-4 text-sm max-h-96 overflow-y-auto">
          ...
          <p>
            Puedes usar nuestra plataforma para compartir y colaborar en proyectos de manera
            constructiva.
          </p>

          <p><strong>3. Contenido del usuario</strong></p>
          <p>
            Eres responsable del contenido que publiques. No se permite contenido ofensivo o ilegal.
          </p>
    ...
    <div v-if="showPrivacy" class="modal modal-open">
      <div class="modal-box max-w-2xl">
        ...
        <div class="space-y-4 text-sm max-h-96 overflow-y-auto">
          ...
          <p>
            Usamos tu información para proporcionarte nuestros servicios y mejorar la experiencia.
          </p>
...
const currentStep = computed(() => {
  if (acceptTerms.value && confirmPassword.value && password.value === confirmPassword.value)
    return 5
